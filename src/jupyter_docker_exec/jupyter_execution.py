...
DOCKERFILE_PATH = "PRELOAD_DOCKERFILE"

class custom_DockerJupyterServer(JupyterConnectable):
    ...
    def __init__(
        ...
        *,
        ...
        self.DEFAULT_DOCKERFILE = open(DOCKERFILE_PATH, mode="r", encoding="utf-8").read()
        ...
        if isinstance(token, custom_DockerJupyterServer.GenerateToken):
